...
ENV PATH /opt/conda/envs/nf-core-proteomicsTMT-1.0.0dev/bin:$PATH
...
RUN conda env export --name nf-core-proteomicsTMT-1.0.0dev > nf-core-proteomicsTMT-1.0.0dev.yml
